...
<head>
  ...
  <title>{{ config('app.name', 'Lara App') }}</title>
...
<div class="wrapper" id="app">
    ...
    <form class="form-inline ml-3">
      <div class="input-group input-group-sm">
        ...
        <div class="input-group-append">
          <button class="btn btn-navbar" v-on:click.prevent="searchit">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="./img/startup.png" alt="Lara App" class="brand-image img-circle elevation-3"
           style="opacity: .8">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="mailto:hamza.devs@gmail.com">Sellouticode.io</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
